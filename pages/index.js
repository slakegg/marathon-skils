...
export default function Home() {
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <p className={`${styles.heroSub} fade-up-delay-2`}>
            Марафон - это не просто забег на дистанцию 42,195 км. Это ежегодный ритуал, который объединяет профессиональных
  атлетов, любителей и тысячи зрителей в едином порыве воли и выносливости.
  Примерно на 30-35 километре многие бегуны сталкиваются с явлением, которое называют «стеной».
  ...
  Для участников это уникальный шанс увидеть город без машин: пробежать по мосту Верразано в Нью-Йорке или мимо Бранденбургских ворот в
  Берлине под крики тысяч болельщиков.
    ТЕЛЕГРАММ БОТ: https://t.me/bestvoiceRustbek
          </p>
